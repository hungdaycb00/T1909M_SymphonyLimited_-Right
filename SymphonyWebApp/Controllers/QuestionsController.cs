...
namespace SymphonyWebApp.Controllers
{
    ...
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Answer")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Answer")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
