    ...
    public static class ModelBuiderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>().HasData(
                new Student() { Id = 1, RollNumber = "213004", FirstName = "Ha", LastName = "Van Vu", Address = "Gia Lai", Gmail = "havanvu18@gmail.com", IdentityCard = "001201303446", StudentStatus = StudentStatus.Active, PhoneNumber = "0825894329", Dob = new DateTime(2020, 02, 13), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 1 },
                new Student() { Id = 2, RollNumber = "214004", FirstName = "Pham", LastName = "Tung Lam", Address = "Lao Cai", Gmail = "phamlamlc14@gmail.com", IdentityCard = "002302446301", StudentStatus = StudentStatus.Active, PhoneNumber = "0328658580", Dob = new DateTime(2020, 03, 14), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 2 },
                new Student() { Id = 3, RollNumber = "215004", FirstName = "Nong", LastName = "Manh Hung", Address = "Cao Bang", Gmail = "nongphanmanhhung93@gmail.com", IdentityCard = "0002304664303", StudentStatus = StudentStatus.Active, PhoneNumber = "0654871956", Dob = new DateTime(2020, 04, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 3 },
                new Student() { Id = 4, RollNumber = "216004", FirstName = "Nguyen", LastName = "Trung Anh", Address = "Ha Noi", Gmail = "nguyentrunganh@gmail.com", IdentityCard = "002404356766", StudentStatus = StudentStatus.Active, PhoneNumber = "0546871264", Dob = new DateTime(2020, 05, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 4 },
                new Student() { Id = 5, RollNumber = "217004", FirstName = "Do", LastName = "Huu Cong", Address = "Ha Noi", Gmail = "huucong473@gmail.com", IdentityCard = "001201072112", StudentStatus = StudentStatus.Active, PhoneNumber = "0889567661", Dob = new DateTime(2020, 06, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 5 },
                new Student() { Id = 6, RollNumber = "213005", FirstName = "Nam", LastName = "Van Va", Address = "Gia Lai", Gmail = "havanvu18@gmail.com", IdentityCard = "001201303433", StudentStatus = StudentStatus.Active, PhoneNumber = "0825894329", Dob = new DateTime(2020, 02, 13), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 1 },
                new Student() { Id = 7, RollNumber = "214006", FirstName = "Pha", LastName = "Tung Lang", Address = "Lao Cai", Gmail = "phamlamlc@gmail.com", IdentityCard = "002302446321", StudentStatus = StudentStatus.Active, PhoneNumber = "0328658581", Dob = new DateTime(2020, 03, 14), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 2 },
                new Student() { Id = 8, RollNumber = "215007", FirstName = "Nog", LastName = "Manh Hong", Address = "Cao Bang", Gmail = "nongphanmanhhung@gmail.com", IdentityCard = "0002304664323", StudentStatus = StudentStatus.Active, PhoneNumber = "0654871952", Dob = new DateTime(2020, 04, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 1, CourseId = 3 },
                new Student() { Id = 9, RollNumber = "216008", FirstName = "Nguy", LastName = "Trung Tanh", Address = "Ha Noi", Gmail = "nguyentrung@gmail.com", IdentityCard = "002404356266", StudentStatus = StudentStatus.Active, PhoneNumber = "0546871263", Dob = new DateTime(2020, 05, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 2, CourseId = 4 },
                new Student() { Id = 10, RollNumber = "217009", FirstName = "Don", LastName = "Huu Conh", Address = "Ha Noi", Gmail = "huucong47@gmail.com", IdentityCard = "001201072132", StudentStatus = StudentStatus.Active, PhoneNumber = "0889567664", Dob = new DateTime(2020, 06, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 2, CourseId = 5 },
                new Student() { Id = 11, RollNumber = "213010", FirstName = "Han", LastName = "Van Nat", Address = "Gia Lai", Gmail = "havanvu1@gmail.com", IdentityCard = "001201303456", StudentStatus = StudentStatus.Active, PhoneNumber = "0825894325", Dob = new DateTime(2020, 02, 13), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 2, CourseId = 1 },
                new Student() { Id = 12, RollNumber = "214011", FirstName = "Phan", LastName = "Tung Lang", Address = "Lao Cai", Gmail = "phamlamlc1@gmail.com", IdentityCard = "002302446304", StudentStatus = StudentStatus.Active, PhoneNumber = "0328658586", Dob = new DateTime(2020, 03, 14), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 2, CourseId = 2 },
                new Student() { Id = 13, RollNumber = "215012", FirstName = "Non", LastName = "Manh Ganh", Address = "Cao Bang", Gmail = "nongphanhhung93@gmail.com", IdentityCard = "0002304664305", StudentStatus = StudentStatus.Active, PhoneNumber = "0654871957", Dob = new DateTime(2020, 04, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 3, CourseId = 3 },
                new Student() { Id = 14, RollNumber = "216013", FirstName = "Nguy", LastName = "Trung", Address = "Ha Noi", Gmail = "nguyenunganh@gmail.com", IdentityCard = "002404356446", StudentStatus = StudentStatus.Active, PhoneNumber = "0546871268", Dob = new DateTime(2020, 05, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 3, CourseId = 4 },
                new Student() { Id = 15, RollNumber = "217014", FirstName = "Dom", LastName = "Huu", Address = "Ha Noi", Gmail = "huucong473@gmail.com", IdentityCard = "001201072119", StudentStatus = StudentStatus.Active, PhoneNumber = "0889567669", Dob = new DateTime(2020, 06, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 3, CourseId = 5 },
                new Student() { Id = 16, RollNumber = "213015", FirstName = "Ham", LastName = "Van", Address = "Gia Lai", Gmail = "havau18@gmail.com", IdentityCard = "001201303447", StudentStatus = StudentStatus.Active, PhoneNumber = "0825894311", Dob = new DateTime(2020, 02, 13), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 3, CourseId = 1 },
                new Student() { Id = 17, RollNumber = "214016", FirstName = "Phat", LastName = "Tung", Address = "Lao Cai", Gmail = "phlamlc14@gmail.com", IdentityCard = "002302446311", StudentStatus = StudentStatus.Active, PhoneNumber = "0328658512", Dob = new DateTime(2020, 03, 14), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 3, CourseId = 2 },
                new Student() { Id = 18, RollNumber = "215017", FirstName = "Nong", LastName = "Manh", Address = "Cao Bang", Gmail = "nonhanmanhhung93@gmail.com", IdentityCard = "0002304664312", StudentStatus = StudentStatus.Active, PhoneNumber = "0654871913", Dob = new DateTime(2020, 04, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 4, CourseId = 3 },
                new Student() { Id = 19, RollNumber = "216018", FirstName = "Nguyen", LastName = "Anh", Address = "Ha Noi", Gmail = "ngentrunganh@gmail.com", IdentityCard = "002404356713", StudentStatus = StudentStatus.Active, PhoneNumber = "0546871214", Dob = new DateTime(2020, 05, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 4, CourseId = 4 },
                new Student() { Id = 20, RollNumber = "217019", FirstName = "Do", LastName = "Cong", Address = "Ha Noi", Gmail = "hcong473@gmail.com", IdentityCard = "001201072114", StudentStatus = StudentStatus.Active, PhoneNumber = "0889567615", Dob = new DateTime(2020, 06, 15), SubFee = 1000, FeeStatus = FeeStatus.Paid, ClassId = 5, CourseId = 5 });
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer() { Id = 1, Name = "Tran Thi Tuyet", Gmail = "tuyettranlc4@gmail.com", PhoneNumber = "0395761476", Contents = "What is the school's facilities and teaching quality like?", CreatingDate = DateTime.Now },
                new Customer() { Id = 2, Name = "Nguyen Van Ngoc", Gmail = "ngocdra@gmail.com", PhoneNumber = "0956137845", Contents = "What will I get during my studies? ", CreatingDate = DateTime.Now },
                new Customer() { Id = 3, Name = "Nguyen Hoai Nam", Gmail = "namot@gmail.com", PhoneNumber = "0986176340", Contents = "Can I take other experiential sessions outside the main school hours?", CreatingDate = DateTime.Now },
                new Customer() { Id = 4, Name = "Pham Tuyet Mai", Gmail = "maioklc@gmail.com", PhoneNumber = "0296753186", Contents = "Can I make a reservation if I miss a midterm?", CreatingDate = DateTime.Now },
                new Customer() { Id = 5, Name = "Le Quang Tho", Gmail = "thobeo8@gmail.com", PhoneNumber = "0364781029", Contents = "Can I leave the course for the next semester too?", CreatingDate = DateTime.Now },
                new Customer() { Id = 6, Name = "Tran Thi Tan", Gmail = "tuyettanl@gmail.com", PhoneNumber = "0395761111", Contents = "What is the school's facilities and teaching quality like?", CreatingDate = DateTime.Now },
                new Customer() { Id = 7, Name = "Nguyen Van Thai", Gmail = "thaidra@gmail.com", PhoneNumber = "0956137222", Contents = "What will I get during my studies? ", CreatingDate = DateTime.Now },
                new Customer() { Id = 8, Name = "Nguyen Hoai Van", Gmail = "Vanot@gmail.com", PhoneNumber = "0986176333", Contents = "Can I take other experiential sessions outside the main school hours?", CreatingDate = DateTime.Now },
                new Customer() { Id = 9, Name = "Pham Tuyet Tho", Gmail = "thoklc@gmail.com", PhoneNumber = "0296753144", Contents = "Can I make a reservation if I miss a midterm?", CreatingDate = DateTime.Now },
                new Customer() { Id = 10, Name = "Le Quang Hai", Gmail = "haibeo8@gmail.com", PhoneNumber = "0364781055", Contents = "Can I leave the course for the next semester too?", CreatingDate = DateTime.Now });
